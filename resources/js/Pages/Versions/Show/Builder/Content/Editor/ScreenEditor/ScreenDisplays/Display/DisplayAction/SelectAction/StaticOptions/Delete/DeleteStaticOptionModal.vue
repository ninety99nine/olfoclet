<template>
    ...
    <DefaultModal
        ...
        :dangerAction="deleteStaticOption">

        <!-- Modal Title -->
        <template v-slot:title>Delete Option</template>

        <!-- Modal Content -->
        <p class="text-sm text-gray-500 mb-5">
            Are you sure you want to delete the
            <span v-if="staticOption.name.code_editor_mode == false" class="text-blue-500 font-bold">{{ staticOption.name.text }}</span>
            option. After this option is deleted you cannot recover it again.
        </p>
