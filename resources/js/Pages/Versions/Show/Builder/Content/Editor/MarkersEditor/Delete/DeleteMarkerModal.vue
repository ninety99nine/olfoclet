<template>
    ...
    <DefaultModal
        ...
        :dangerAction="deleteMarker">

        <!-- Modal Title -->
        <template v-slot:title>Delete Marker</template>

        <!-- Modal Content -->
        <p class="text-sm text-gray-500 mb-5">
            Are you sure you want to delete the
            <span class="text-blue-500 font-bold">{{ marker }}</span>
            marker. After this marker is deleted you cannot recover it again.
        </p>
