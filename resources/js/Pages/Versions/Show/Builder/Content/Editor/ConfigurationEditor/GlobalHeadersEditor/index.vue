                ...
                <div class="flex items-center justify-end">
                    ...
                    <Transition name="fade" mode="out-in">
                        ...
                        <div :key="checkedIndexes.length">
                            ...
                            <DeleteGlobalHeaderModal v-if="checkedIndexes.length > 0" :headers="useVersionBuilder.builder.global_headers" :indexes="checkedIndexes" mode="multiple" @deleted="resetCheckboxes()"></DeleteGlobalHeaderModal>

                            <CreateOrUpdateGlobalHeaderModal v-else :headers="useVersionBuilder.builder.global_headers" mode="create"></CreateOrUpdateGlobalHeaderModal>
            ...
            <table class="w-full text-sm text-left text-gray-500">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th v-for="(columnName, index) in columnNames" :key="index" scope="col" class="px-6 py-3">
                ...
                <draggable
                    ...
                    v-model="useVersionBuilder.builder.global_headers">
                    <template v-for="(element, index) in useVersionBuilder.builder.global_headers">
                            ...
                            <td scope="row">
                                <div class="flex justify-end">
                                    <div class="opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-end mr-4">
                                        ...
                                        <!-- Update Modal Button -->
                                        <CreateOrUpdateGlobalHeaderModal :headers="useVersionBuilder.builder.global_headers" :header="element" :index="index" mode="update"></CreateOrUpdateGlobalHeaderModal>

                                        <!-- Clone Modal Button -->
                                        <CreateOrUpdateGlobalHeaderModal :headers="useVersionBuilder.builder.global_headers" :header="element" mode="clone"></CreateOrUpdateGlobalHeaderModal>

                                        <!-- Delete Modal Button -->
                                        <DeleteGlobalHeaderModal :headers="useVersionBuilder.builder.global_headers" :header="element" :index="index" mode="single"></DeleteGlobalHeaderModal>
...
<script>
    ...
    import DeleteGlobalHeaderModal from "./DeleteGlobalHeader/DeleteGlobalHeaderModal";
    import CreateOrUpdateGlobalHeaderModal from './CreateOrUpdateGlobalHeader/CreateOrUpdateGlobalHeaderModal';

    export default {
        components: { draggable: VueDraggableNext, DefaultError, TextEditor, HiddenCode, DefaultSearchBar, CreateOrUpdateGlobalHeaderModal, DangerButton, DeleteGlobalHeaderModal },
        data(){
            return {
        ...
        methods: {
            startSearch(searchTerm) {
                ...
                this.useVersionBuilder.builder.global_headers.map((header, index) => {
            ...
            toggleMultipleCheckmarks(event){
                ...
                if( event.target.checked ) {
                    ...
                    this.useVersionBuilder.builder.global_headers.forEach((header, index) => this.checkedIndexes.push(index));
