            ...
            return {
                ...
                availableRules: [
                    ...
                    },
                    {
                        ...
                        comment: 'Makes sure that the target value contains a valid date format (DDMMYYYY) e.g 02082020. The date must be correct therefore 02132020 is invalid since there is no 13th month.'
                    },
                    {
                        ...
                        comment: 'Makes sure that the target value contains a valid date format (DD/MM/YYYY) e.g 02/08/2020. This also works for other similar date formats e.g 2/8/2020 or 2/08/2020 or 02/8/2020. The date must be correct therefore 02/13/2020 is invalid since there is no 13th month.'
                    },
                    {
                        name: 'Validate Date Format (DD-MM-YYYY)',
