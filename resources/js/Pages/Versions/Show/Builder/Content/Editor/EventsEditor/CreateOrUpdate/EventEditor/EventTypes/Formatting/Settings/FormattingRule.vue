        ...
        <div @click="toggleSelection()" :class="['grid grid-cols-12 group text-xs text-gray-700 py-2 px-4 cursor-pointer', active ? 'border-b border-dashed bg-blue-50 rounded-t-md' : 'bg-gray-50 rounded-md']">
            ...
            <div class="col-span-6 flex justify-end items-center relative">
                ...
                <div class="absolute right-0 flex items-center justify-end opacity-0 group-hover:opacity-100">
                    ...
                    <!-- Edit Icon -->
                    <CloneOrUpdateFormattingRuleModal :rules="rules" :rule="rule" :index="index" mode="update"></CloneOrUpdateFormattingRuleModal>

                    <!-- Delete Icon -->
                    <DeleteFormattingRuleModal :rules="rules" :rule="rule" :index="index"></DeleteFormattingRuleModal>

                    <!-- Clone Icon -->
                    <CloneOrUpdateFormattingRuleModal :rules="rules" :rule="rule" mode="clone"></CloneOrUpdateFormattingRuleModal>
                    ...
                    <div class="ml-4 mr-1">
                        <InfoPopover :title="rule.type">
                            ...
                            <div class="border-t border-dashed pt-4 mt-4">
                                <p class="text-xs text-gray-600 break-normal">Formatting rule details ...</p>
                            </div>
...
<script>
    ...
    import DeleteFormattingRuleModal from './DeleteFormattingRule/DeleteFormattingRuleModal';
    import CloneOrUpdateFormattingRuleModal from './CloneOrUpdateFormattingRule/CloneOrUpdateFormattingRuleModal';

    export default {
        props: ['rules', 'rule', 'index'],
        components: { SlideUpDown, InfoPopover, SuccessBadge, PrimaryBadge, WarningBadge, DefaultColorPicker, DeleteFormattingRuleModal, CloneOrUpdateFormattingRuleModal },
        data(){
            return {
                active: false
            }
