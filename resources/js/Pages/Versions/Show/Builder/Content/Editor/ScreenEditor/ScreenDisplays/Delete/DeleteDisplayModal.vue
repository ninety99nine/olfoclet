<template>
    ...
    <DefaultModal
        ...
        :dangerAction="deleteDisplay">

        <!-- Modal Title -->
        <template v-slot:title>Delete Display</template>

        <!-- Modal Content -->
        <p class="text-sm text-gray-500 mb-5">Are you sure you want to delete the <span class="text-blue-500 font-bold">{{ display.name }}</span> display. After this display is deleted you cannot recover it again.</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            deleteDisplay(closeModal) {

                //  Check if we have selected this display for veiwing
                const hasSelectedCurrentDisplay = this.useVersionBuilder.hasSelectedSpecificDisplay(this.display);
                ...
                const hasDisplayMarkedAsFirstDisplay = this.useVersionBuilder.hasDisplayMarkedAsFirstDisplay();
                ...
                if( this.useVersionBuilder.hasScreenDisplays ) {
                    ...
                    if( hasDisplayMarkedAsFirstDisplay == false ) {
                        ...
                        this.useVersionBuilder.markDisplayAsFirstDisplay(

                            this.useVersionBuilder.screenDisplays[0]
