...
<script>
    ...
    export default {
        ...
        components: { DefaultSelect, DefaultSearchBar, DefaultCheckbox },
        data() {
            return {
        ...
        methods: {
            ...
            refreshContent(canCancel = true) {
                ...
                axios.get(url, config).then((response) => {
                    ...
                    this.totalAccounts = statistics.totalAccounts,
                    this.totalMobileAccounts = statistics.totalMobileAccounts,
                    this.totalSimulatorAccounts = statistics.totalSimulatorAccounts,
