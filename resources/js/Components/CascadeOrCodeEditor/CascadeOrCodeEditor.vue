    ...
    <div>
        ...
        <div class="flex items-center">
            ...
            <Transition name="fade" mode="out-in" :duration="250">
                ...
                <div v-if="localModelValue.code_editor_mode == false" class="ml-2">
...
export default {
    ...
    watch: {
        ...
        localSelectedValues(newValue, oldValue) {
            this.$emit('update:selectedValues', newValue);
        }
    },
    methods: {
        updateLink(values) {
            ...
            if( values == null ) {
                ...
                this.localModelValue.text = '';

                //  Update the localSelectedValues
            ...
            //  If we have an array of values
                ...
                this.localModelValue.text = lastValue;

                //  Update the localSelectedValues
                this.localSelectedValues = values;
