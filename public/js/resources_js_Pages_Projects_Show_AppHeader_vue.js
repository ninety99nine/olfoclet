"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Projects_Show_AppHeader_vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    startSearch: function startSearch(search) {
      var routeName = this.isShowingApps ? 'project.show.with.apps' : 'project.show.with.trashed.apps';
    ...
    checkIfShowingApps: function checkIfShowingApps() {
      return route().current('project.show.with.apps', {
        project: this.route().params.project
      });
    },
    checkIfShowingTrashedApps: function checkIfShowingTrashedApps() {
      return route().current('project.show.with.trashed.apps', {
        project: this.route().params.project
      });
    },
    toggleApps: function toggleApps() {
      this.isShowingTrashedApps ? this.showApps() : this.showTrashedApps();
    },
    showApps: function showApps() {
      this.changeRoute(route('project.show.with.apps', {
        project: this.route().params.project
      }));
    },
    showTrashedApps: function showTrashedApps() {
      this.changeRoute(route('project.show.with.trashed.apps', {
        project: this.route().params.project
      }));
    },
...
var _hoisted_8 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", null, "Showing trashed apps", -1 /* HOISTED */);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_1, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h1", _hoisted_2, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.isShowingApps ? 'Apps' : 'Trashed Apps'), 1 /* TEXT */), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("h2", _hoisted_3, "Select an app to " + (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.isShowingApps ? 'build' : 'restore'), 1 /* TEXT */)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DefaultSwitch, {
    value: $data.isShowingTrashedApps,
    onChange: _cache[0] || (_cache[0] = function ($event) {
      return $options.toggleApps();
    }),
    note: "Show trashed apps",
    disabled: $data.isChangingRoute
  }, null, 8 /* PROPS */, ["value", "disabled"]), $data.projectPayload.trashed_apps_count ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_NumberBadge, {
    key: 0,
    count: $data.projectPayload.trashed_apps_count
  ...
  }, null, 8 /* PROPS */, ["modelValue", "onOnSearch"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Explainer "), $data.isShowingTrashedApps ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PrimaryAlert, {
    key: 0,
    "class": "mb-12"
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
